 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Ian Haessler");
		  toPrint += p1.toString("903237812");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("TaViana Crum");
		  toPrint += p2.toString("tcrum3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("nina");
		  toPrint += p3.toString("nqin7");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Luke Muehring");
          toPrint += p4.toString("lmuehring3");
